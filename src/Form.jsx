    ...
    <div>
      {showResult ? (
            ...
            >
              <div class="shadow">
                <div class="flex items-center  rounded-t-lg border-gray-500 border-b">
                  <label
                    for="name"
                    class="w-20 text-right mr-8 p-4 text-blue-500"
                  >
                    Name
                  </label>
                  <input
                ...
                <div class="flex items-center   rounded-b-lg border-gray-500 border-b">
                  <label
                    for="email"
                    class="w-20 text-right p-4 mr-8 text-blue-500"
                  >
                    Email
                  </label>
                  <input
        ...
        <div>
          ...
          >
            Registration{" "}
            <span class="text-yellow-600 dark:text-blue-500">Successfull </span>
          </h1>
          <div class="  min-h-screen flex items-center text-lg">
            <Link
              to={`${moveToResult}`}
